<div data-role="content" id="contenido_pagina">
      <form class="form-signin_inicio_sesion" name = 'form_cargas' id = 'form_cargas' enctype="multipart/form-data" action="<?php echo base_url() ?>Archivos/cargas_post" method='POST'>

        <h3 class="form-signin-heading">Seleccione los archivos a subir</h3>
  <!--        <hr class="colorgraph">-->
        ...
        <?php echo form_open_multipart('upload/do_upload');?>
          ...
          <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6 ancho_fila">    
              <label for="userfile" class="control-label">Archivos</label>
