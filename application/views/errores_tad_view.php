<div data-role="content" id="contenido_pagina">
      <form class="form-signin_inicio_sesion" name = 'form_cargas' id = 'form_cargas' enctype="multipart/form-data" action="<?php echo base_url() ?>Tad/errores_post" method='POST'>

        <h3 class="form-signin-heading">Seleccione el archivo de errores a registrar</h3>
  <!--        <hr class="colorgraph">-->
  ...
  <div id = "row"><div id = "col" class="Lines2"></div></div><br><br>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6 ancho_fila">    
              <input type="submit" class="btn boton" data-theme="b" value='Procesar'/><br>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6 ancho_fila">    
