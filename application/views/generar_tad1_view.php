<div data-role="content" id="contenido_pagina">
    <form class="form-signin_inicio_sesion" name = 'form_cargas' id = 'form_cargas' action="<?php echo base_url().'Tad/'.($t_tramite == 'I' ? 'generar_tad1' : 'generar_tad_ddjj'); ?>" method='POST'>
        <h3 class="form-signin-heading">Generacion de TAD</h3>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6 ancho_fila">    
              <input type="submit" class="btn boton" data-theme="b" value='Generar CSV'/><br>
			  <input type="hidden" name="t_tramite" id="t_tramite" value="<?php echo $t_tramite; ?>">
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6 ancho_fila">    
