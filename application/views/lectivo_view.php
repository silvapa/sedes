<form class="form-signin-grande" name = 'form_lectivo' id = 'form_lectivo' action="<?php echo base_url() ?>Lectivo/lectivo_post" method='POST'>
<div data-role="content"  id="div_scroll"> 
 ...
 <!--  <div class="clase_encabe" > -->
  <table class="table-responsive" id="tabla_descargas2">
    <thead>
    <tr>
    <td style='padding:3px' width="05%"><input type='text' class = 'blocked' name='anio' id='anio' value="<?php if (isset($anio)) {echo $anio;} ?>" placeholder="A&ntilde;o"></td>
    <td style='padding:3px' width="08%"><input type='text' class = 'blocked' name='clave' id='clave' value="<?php if (isset($clave) && ($clave != 0)) {echo $clave;} ?>" placeholder="Clave"></td>
    <td style='padding:3px' width="12%"><input type='text' class = 'blocked' name='dni' id='dni' value="<?php if (isset($dni)) {echo $dni;} ?>" placeholder="D.N.I."></td>
    <td style='padding:3px' width="30%"><input type='text' class = 'blocked' name='apellido' id='apellido' value="<?php if (isset($apellido)) {echo $apellido;} ?>" placeholder="Apellido"></td>
    <td style='padding:3px' width="30%"><input type='text' class = 'blocked' name='nombre' id='nombre' value="<?php if (isset($nombre)) {echo $nombre;} ?>" placeholder="Nombre"></td>
    <td style='padding:3px' width="05%"><button type="submit" class="btn boton" data-theme="b" value="Buscar" title="Buscar">Buscar</button></td>  
    <td style='padding:3px' width="05%"><a href="<?php echo base_url() ?>Lectivo/consultar" class="btn boton" role="button">Grilla</a></td>  
    <td style='padding:3px' width="05%"><a href="<?php echo base_url() ?>Main/Principal" class="btn boton" role="button">Volver</a></td>  
    </tr>
    </thead>
    </table>
...
$(document).ready(function() {
  ...
  $( "tr" ).dblclick(function() {
    ...
    document.getElementById('form_lectivo').submit();    
 });        
});
