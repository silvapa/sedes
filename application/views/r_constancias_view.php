...
<form class="form-signin_inicio_sesion" name = 'form_r_constancia' id = 'form_r_constancia' onsubmit="return validateForm()" method="get" action="<?php echo base_url(); ?>export_csv/export">

    <h3 class="form-signin-heading">Seleccione rango de fechas a listar</h3>
