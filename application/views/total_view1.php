...
<div data-role="content"  id="div_scroll"> 
    ...
    <?php if (($error == '') && (count($datos) > 0)): ?> 
        <div class="row texto_cabecera">
            ...
            <?php
                echo "<p align='left' style='margin-left: 10px;'>Alumno: <b>".$datos[0]['apellido'].", ".$datos[0]['nombre']."</b></p>";
            ?>
            </div>
...
<!--          <div class="card">
           <div class="card-body">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4"> 
                <br>
                <div class="row">
                    <h4>El alumno presenta la siguiente documentacion</h4><br>
                    <div class = "radio"  >
                ...
                <?php if (isset($datos[0]['sede1']) && ($datos[0]['sede1'] > 0)) {
                    ...
                    echo '<button type="submit" class="btn boton" data-theme="b" style="margin:20px"  value="Grabar" title="Grabar">Grabar</button>';
                    echo '<a href="<?php echo base_url() ?>Constancias/Consultar" class="btn boton" style="margin:20px" role="button"> Cancelar </a><br>';
                    echo '<br>';
                    echo '</div>';
                };    
                ?>
