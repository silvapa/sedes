<?php 
   ...
   include($ruta.'mail_JQ.php'); // deja el contenido del cuerpo del mail en la variable $contenido
   ...
   $sql = "select Expediente, APELLIDO_SOLICITANTE, NOMBRE_SOLICITANTE, EMAIL 
            ...
            and t_tramite='J' 
            and t_mail_enviar_cbc='Q' LIMIT 2";
    ...
    $mensaje = $contenido;
       ...
       $mensaje = str_replace("{nombre_alumno}", $nombre_destinatario, $mensaje);
		 if (mandar_mail($to, $from, $tema, $mensaje, $nombre_destinatario)) {
			 ...
			 $update = "update tadddjj set mail_enviado_cbc='P', mensaje='".$ahora."' where Expediente='".$id."'";
		 }else{
