<?php 
   ...
   include($ruta.'mail_I1.php'); // deja el contenido del cuerpo del mail en la variable $contenido
   ...
   $tema = "INSCRIPCION 2021 RESULTADO";
   $from = "inscripcion1@cbc.uba.ar";
   ...
   $sql = "select Expediente, APELLIDO_SOLICITANTE, NOMBRE_SOLICITANTE, EMAIL 
            ...
            and t_tramite='I' 
            and t_mail_enviar_cbc='1' LIMIT 600";
   ...
   if (mysqli_errno($coneccion)==0) {
       ...
       $mensaje = str_replace("{nombre_alumno}", $nombre_destinatario, $mensaje);
		 if (mandar_mail($to, $from, $tema, $mensaje, $nombre_destinatario)) {
			 ...
			 $update = "update tad1 set mail_enviado_cbc='N', mensaje="."'Error envio mail: ".$ahora."' where Expediente='".$id."'";		 
		 }
