<?php 
   ...
   //$sql = "select Expediente, APELLIDO_SOLICITANTE, NOMBRE_SOLICITANTE, EMAIL from tad1 where expediente='EX-1985-090849-REM-4288' or expediente='EX-1986-025278-REM-2550'";
